...
public final class ActivityAuthenBinding implements ViewBinding {
  ...
  @NonNull
  public static ActivityAuthenBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityAuthenBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_authen, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityAuthenBinding bind(@NonNull View rootView) {
